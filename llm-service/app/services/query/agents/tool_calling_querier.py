...
6. If you use the image generation tool, you will provide the image \
name in the response as a markdown image link ![<image_name>](<image_url>), \
where <image_name> is the name of the image and <image_url> \
is the URL or path of the image generated by the image generation tool. \
