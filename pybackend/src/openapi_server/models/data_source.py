...
class DataSource(BaseModel):
    ...
    DataSource
    """ # noqa: E501
    id: StrictInt = Field(description="Data source ID")
    name: StrictStr = Field(description="Data source name")
    time_created: datetime = Field(description="Data source creation timestamp")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "time_created", "time_updated", "created_by_id", "updated_by_id", "configuration", "status"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": DataSourceConfiguration.from_dict(obj.get("configuration")) if obj.get("configuration") is not None else None,
            "status": DataSourceStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
