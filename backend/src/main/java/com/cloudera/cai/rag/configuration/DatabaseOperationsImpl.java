...
/**
 * Implementation of DatabaseOperations that delegates to a Jdbi instance. This is the production
 * implementation that wraps the actual Jdbi operations.
 */
public class DatabaseOperationsImpl implements DatabaseOperations {

  private final Jdbi jdbi;

  public DatabaseOperationsImpl(Jdbi jdbi) {
    this.jdbi = jdbi;
  }
