...
from .base_indexer import BaseTextIndexer
from .readers.base_reader import ReaderConfig
...
class EmbeddingIndexer(BaseTextIndexer):
    ...
    def index_file(self, file_path: Path, document_id: str) -> None:
        ...
        chunks_with_embeddings = flatten_sequence(
            self._compute_embeddings(chunks.chunks)
        )
